...
namespace Vts.FemModeling.MGRTE._2D
{
    ...
    public static class MathFunctions
    {
        ...
        private static void BasicSquareMesh(
            ...
            int[][] tri)
        {
            pts[0][0] = -0.5; pts[0][1] = 0.5;  pts[0][2] = 0; pts[0][3] = 1;
            pts[1][0] =  0.5; pts[1][1] = 0.5;  pts[1][2] = 1; pts[1][3] = 1;
            pts[2][0] =  0.5; pts[2][1] = -0.5; pts[2][2] = 2; pts[2][3] = 1;
            pts[3][0] = -0.5; pts[3][1] = -0.5; pts[3][2] = 3; pts[3][3] = 1;
