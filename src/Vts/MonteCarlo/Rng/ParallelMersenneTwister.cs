...
namespace Vts.MonteCarlo.Rng
{
    ...
    public class ParallelMersenneTwister : MathNet.Numerics.Random.RandomSource
    {
        ...
        /// struct for dc MT
        /// </summary>
        struct _check32_t { uint upper_mask; uint lower_mask; uint word_mask; }
        /// <summary>
        ...
        public ParallelMersenneTwister()
        ...
        /// </summary>
        /// <param name="threadSafe">if set to <c>true</c> , the class is thread safe.</param>
        public ParallelMersenneTwister(bool threadSafe)
        ...
        public static ParallelMersenneTwister Create(MersenneTwisterSerializationInfo info)
        {
            return new ParallelMersenneTwister
            {
                MT = info.MT,
                MTI = info.MTI
            };
        ...
        //private int check_period_dc(_check32_t ck, )
        //{
