...
namespace Vts.MonteCarlo
{
    ...
    public class pMCSurfaceVirtualBoundaryInputValidation
    {
            ...
            foreach (var detectorInput in vbInput.DetectorInputs)
	        {
                if (!detectorInput.TallyType.IsSurfaceTally())
                {
                    return new ValidationResult(
                        false,
                        "pMCSurfaceVirtualBoundaryInput: detector input is not a surface type",
                    ...
                    !detectorInput.TallyType.IsInternalSurfaceTally()))
                {
                    return new ValidationResult(
                        false,
                        "pMCSurfaceVirtualBoundaryInput: detector input not consistent with virtual boundary type",
