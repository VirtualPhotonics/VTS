...
namespace Vts.MonteCarlo.Tissues
{
    ...
    public class CaplessVoxelTissueRegion : ITissueRegion
    {
        ...
        /// <param name="phaseFunctionKey">key to Phase Function Dictionary</param>
        public CaplessVoxelTissueRegion(DoubleRange x, DoubleRange y, DoubleRange z, 
        ...
        /// <summary>
        /// key for the phase function dictionary in a class that implements ITissue
        /// </summary>
