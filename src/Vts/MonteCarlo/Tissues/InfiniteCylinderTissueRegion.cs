...
namespace Vts.MonteCarlo.Tissues
{
    ...
    public class InfiniteCylinderTissueRegion : ITissueRegion
    {
        ...
        /// <param name="phaseFunctionKey">key into phase function dictionary</param>
        public InfiniteCylinderTissueRegion(Position center, double radius, OpticalProperties op, string phaseFunctionKey) 
        {
