...
namespace Vts.MonteCarlo.VirtualBoundaries
{
    ...
    /// </summary>
    public class PhotonEmissionReflectanceVirtualBoundary : IVirtualBoundary
    {
        ...
        public PhotonEmissionReflectanceVirtualBoundary(ITissue tissue, IDetectorController detectorController, string name)
        {
