...
namespace Vts.MonteCarlo
{
    ...
    /// </summary>
    public class dMCdROfRhodMuaDetectorInput : IpMCDetectorInput 
    {
        /// <summary>
        /// constructor for differential Monte Carlo reflectance with respect to mua, as a function of rho detector input
        /// </summary>
