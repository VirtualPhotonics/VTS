...
namespace Vts.MonteCarlo
{
    ...
    public class SimulationOutput
    {
        ...
        /// </summary>
        public double[,,,] RefMT_rs_frac { get { return ((ReflectedMTOfRhoAndSubregionHistDetector)ResultsDictionary[_detectorResults.Where(d => d.TallyType == "ReflectedMTOfRhoAndSubregionHist").First().Name]).FractionalMT; } }
        /// <summary>
