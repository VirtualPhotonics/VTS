...
namespace Vts.MonteCarlo.Detectors
{
    ...
    /// </summary>
    public class pMCTOfRhoDetectorInput : DetectorInput, IDetectorInput
    {
        /// <summary>
        /// constructor for pMC transmittance as a function of rho detector input
        /// </summary>
        public pMCTOfRhoDetectorInput()
        {
            TallyType = "pMCTOfRho";
            Name = "pMCTOfRho";
            ...
            TallyDetails.IspMCTransmittanceTally = true;
        }
        /// <summary>
    ...
    /// </summary>
    public class pMCTOfRhoDetector : Detector, IDetector
    {
