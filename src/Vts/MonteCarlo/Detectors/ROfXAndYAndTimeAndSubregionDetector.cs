...
namespace Vts.MonteCarlo.Detectors
{
    ...
    public class ROfXAndYAndTimeAndSubregionDetectorInput : DetectorInput, IDetectorInput
    {
        ...
        /// </summary>
        public ROfXAndYAndTimeAndSubregionDetectorInput()
        {
            TallyType = "ROfXAndYAndTimeAndSubregion";
            Name = "ROfXAndYAndTimeAndSubregion";
        ...
        {
            return new ROfXAndYAndTimeAndSubregionDetector
            {
    ...
    /// </summary>
    public class ROfXAndYAndTimeAndSubregionDetector : Detector, IDetector
    {
