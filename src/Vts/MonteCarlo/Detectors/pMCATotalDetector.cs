...
namespace Vts.MonteCarlo.Detectors
{
    ...
    public class pMCATotalDetector : Detector, IDetector
    {
        ...
        private Func<PhotonDataPoint, IList<double>, IList<OpticalProperties>, IList<OpticalProperties>, IList<int>, double> _absorptionWeightingMethod;
        ...
        public long TallyCount { get; set; }
          ...
          /// <summary>
        /// initialize detector arrays given tissue and RNG
        /// </summary>
