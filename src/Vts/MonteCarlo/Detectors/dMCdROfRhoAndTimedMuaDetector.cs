...
namespace Vts.MonteCarlo.Detectors
{
    ...
    /// </summary>
    public class dMCdROfRhoAndTimedMuaDetectorInput : DetectorInput, IDetectorInput
    {
        /// <summary>
        /// constructor for pMC reflectance as a function of rho detector input
        /// </summary>
        public dMCdROfRhoAndTimedMuaDetectorInput()
        {
            TallyType = "dMCdROfRhoAndTimedMua";
            Name = "dMCdROfRhoAndTimedMua";
    ...
    /// </summary>
    public class dMCdROfRhoAndTimedMuaDetector : Detector, IDetector
    {
        ...
        public void Tally(Photon photon)
        {
            ...
            // WhichBin to match pMCROfRhoAndTime which matches ROfRhoAndTime
