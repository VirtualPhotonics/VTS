...
{
    /// <summary>
    /// Tally for dMC estimation of the derivative or reflectance with respect to mus as a function of Fx.
    /// </summary>
    public class dMCdROfFxdMusDetectorInput : DetectorInput, IDetectorInput
    {
        /// <summary>
        /// constructor for pMC reflectance as a function of rho detector input
        /// </summary>
        public dMCdROfFxdMusDetectorInput()
        {
            TallyType = "dMCdROfFxdMus";
            Name = "dMCdROfFxdMus";
        ...
        {
            return new dMCdROfFxdMusDetector
            {
    ...
    /// </summary>
    public class dMCdROfFxdMusDetector : Detector, IDetector
    {
