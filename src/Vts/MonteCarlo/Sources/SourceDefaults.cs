...
namespace Vts.MonteCarlo.Sources
{
    public class SourceDefaults
    {
        ...
        public static ThreeAxisRotation DefaultRotationOfPrincipalSourceAxis = new ThreeAxisRotation(0.0, 0.0, 0.0);
        public static Direction DefaultDirection = new Direction(0.0, 0.0, 1.0);
    }
}
