...
namespace Vts.MonteCarlo.Sources
{
    ...
    /// 
    /// </summary>
    public class LineSourceCollimatedFlat: ISource
    {        
        ...
        /// <summary>
        /// Returns an instance of Collimated Flat Line Source with a specified translation, inward normal rotation, and source axis rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="translationFromOrigin"></param>
        /// <param name="rotationFromInwardNormal"></param>
        /// <param name="rotationOfPrincipalSourceAxis"></param>
        public LineSourceCollimatedFlat(
            double lineLength,            
        ...
        /// <summary>
        /// Returns an instance of Collimated Flat Line Source with a specified translation and inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="translationFromOrigin"></param>
        /// <param name="rotationFromInwardnormal"></param>
        ...
        /// <summary>
        /// Returns an instance of Collimated Flat Line Source with a specified translation and source axis rotation, but without inward normal rotation 
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="translationFromOrigin"></param>
        /// <param name="rotationOfPrincipalSourceAxis"></param>
        ...
        /// <summary>
        /// Returns an instance of Collimated flat Line Source with a specified translation but without inward normal rotation or source axis rotation 
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="translationFromOrigin"></param>
        public LineSourceCollimatedFlat(
        ...
        /// <summary>
        /// Returns an instance of Collimated flat Line Source with an inward normal rotation and source axis rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="rotationFromInwardnormal"></param>
        /// <param name="rotationOfPrincipalSourceAxis"></param>
        ...
        /// <summary>
        /// Returns an instance of Collimated flat Line Source with an inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="rotationFromInwardnormal"></param>
        public LineSourceCollimatedFlat(
        ...
        /// <summary>
        /// Returns an instance of Collimated flat Line Source with a source axis rotation, but without inward normal rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="rotationOfPrincipalSourceAxis"></param>
        public LineSourceCollimatedFlat(
        ...
        /// <summary>
        /// Returns an instance of Collimated flat Line Source with no inward normal rotation or source axis rotation 
        /// </summary>
        /// <param name="lineLength"></param>
        public LineSourceCollimatedFlat(
            double lineLength)
