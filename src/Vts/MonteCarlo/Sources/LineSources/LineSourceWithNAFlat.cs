...
namespace Vts.MonteCarlo.Sources
{
    ...
    /// 
    /// </summary>
    public class LineSourceWithNAFlat: ISource
    {
        ...
        /// <summary>
        /// Returns an instance of Flat Line Source with a specified translation, inward normal rotation, and source axis rotation
        /// </summary>
        ...
        /// <summary>
        /// Returns an instance of Flat Line Source with a specified translation and inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="numericalAperture"></param>
        /// <param name="translationFromOrigin"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Line Source with a specified translation and source axis rotation, but without inward normal rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="numericalAperture"></param>
        /// <param name="translationFromOrigin"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Line Source with a specified translation but without inward normal rotation or source axis rotation 
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="numericalAperture"></param>
        /// <param name="translationFromOrigin"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Line Source with an inward normal rotation and source axis rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="numericalAperture"></param>
        /// <param name="rotationFromInwardnormal"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Line Source with an inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="numericalAperture"></param>
        /// <param name="rotationFromInwardnormal"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Line Source with a source axis rotation, but without inward normal rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="numericalAperture"></param>
        /// <param name="rotationOfPrincipalSourceAxis"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Line Source with no inward normal rotation or source axis rotation
        /// </summary>
        /// <param name="lineLength"></param>
        /// <param name="numericalAperture"></param>
        public LineSourceWithNAFlat(
