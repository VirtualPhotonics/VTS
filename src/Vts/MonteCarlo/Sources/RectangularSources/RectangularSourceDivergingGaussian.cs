...
namespace Vts.MonteCarlo.Sources
{
    ...
    /// 
    /// </summary>
    public class RectangularSourceDivergingGaussian : ISource
    {
        ...
        /// <summary>
        /// Returns an instance of Diverging Gaussian Rectangular Source with a specified translation, inward normal rotation, and source axis rotation
        /// </summary>
        ...
        public RectangularSourceDivergingGaussian(
            double rectLengthX,
            double rectLengthY,
        ...
        /// <summary>
        /// Returns an instance of Diverging Gaussian Rectangular Source with a specified translation and inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Diverging Gaussian Rectangular Source with a specified translation and source axis rotation, but without inward normal rotation 
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Diverging Gaussian Rectangular Source with a specified translation but without inward normal rotation or source axis rotation 
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Diverging Gaussian Rectangular Source with an inward normal rotation and source axis rotation
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Diverging Gaussian Rectangular Source with an inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Diverging Gaussian Rectangular Source with a source axis rotation, but without inward normal rotation
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Diverging Gaussian Rectangular Source with no inward normal rotation or source axis rotation 
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="gaussianStdDevX"></param>
