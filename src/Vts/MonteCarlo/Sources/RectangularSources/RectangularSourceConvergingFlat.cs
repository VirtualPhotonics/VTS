...
namespace Vts.MonteCarlo.Sources
{
    ...
    /// 
    /// </summary>
    public class RectangularSourceConvergingFlat : ISource
    {
        ...
        /// <summary>
        /// Returns an instance of Converging Flat Rectangular Source with a specified translation, inward normal rotation, and source axis rotation
        /// </summary>
        ...
        public RectangularSourceConvergingFlat (
            double rectLengthX,
            double rectLengthY,
        ...
        /// <summary>
        /// Returns an instance of Converging Flat Rectangular Source with a specified translation and inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Converging Flat Rectangular Source with a specified translation and source axis rotation, but without inward normal rotation 
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Converging Flat Rectangular Source with a specified translation but without inward normal rotation or source axis rotation 
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Converging Flat Rectangular Source with an inward normal rotation and source axis rotation
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Converging Flat Rectangular Source with an inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Converging Flat Rectangular Source with a source axis rotation, but without inward normal rotation
        /// </summary>
        /// <param name="rectLengthX"></param>
        /// <param name="rectLengthY"></param>
        /// <param name="numericalAperture"></param>
       ...
       /// <summary>
        /// Returns an instance of Converging Flat Rectangular Source with no inward normal rotation or source axis rotation 
       /// </summary>
       /// <param name="rectLengthX"></param>
       /// <param name="rectLengthY"></param>
       /// <param name="numericalAperture"></param>
