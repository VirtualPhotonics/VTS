...
namespace Vts.MonteCarlo.Sources
{
    ...
    /// 
    /// </summary>
    public class EllipticalSourceWithNAFlat: ISource
    {
        ...
        /// <summary>
        /// Returns an instance of Flat Elliptical Source with a specified translation, inward normal rotation, and source axis rotation
        /// </summary>
        ...
        public EllipticalSourceWithNAFlat(
            double aParameter,
            double bParameter,
        ...
        /// <summary>
        /// Returns an instance of Flat Elliptical Source with a specified translation and inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Elliptical Source with a specified translation and source axis rotation, but without inward normal rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Elliptical Source with a specified translation but without inward normal rotation or source axis rotation 
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Elliptical Source with an inward normal rotation and source axis rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Elliptical Source with an inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Elliptical Source with a source axis rotation, but without inward normal rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="numericalAperture"></param>
        ...
        /// <summary>
        /// Returns an instance of Flat Elliptical Source with no inward normal rotation or source axis rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="numericalAperture"></param>
