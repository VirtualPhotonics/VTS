...
namespace Vts.MonteCarlo.Sources
{
    ...
    /// 
    /// </summary>
    public class EllipticalSourceWithNAGaussian : ISource
    {
        ...
        /// <summary>
        /// Returns an instance of Gaussian Elliptical Source with a specified translation, inward normal rotation, and source axis rotation
        /// </summary>
        ...
        public EllipticalSourceWithNAGaussian(
            double aParameter,
            double bParameter,
        ...
        /// <summary>
        /// Returns an instance of Gaussian Elliptical Source with a specified translation and inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Gaussian Elliptical Source with a specified translation and source axis rotation, but without inward normal rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Gaussian Elliptical Source with a specified translation but without inward normal rotation or source axis rotation 
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Gaussian Elliptical Source with an inward normal rotation and source axis rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Gaussian Elliptical Source with an inward normal rotation, but without source axis rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Gaussian Elliptical Source with a source axis rotation, but without inward normal rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="gaussianStdDevX"></param>
        ...
        /// <summary>
        /// Returns an instance of Gaussian Elliptical Source with no inward normal rotation or source axis rotation
        /// </summary>
        /// <param name="aParameter"></param>
        /// <param name="bParameter"></param>
        /// <param name="gaussianStdDevX"></param>
