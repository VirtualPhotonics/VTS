...
internal class Demo06FluenceOfRhoAndZTwoLayer : IDemoScript
{
    ...
    public static void RunDemo(bool showPlots = true)
    {
        ...
        var rhos = new DoubleRange(start: 0.1, stop: 20.0, number: 100).AsEnumerable().ToArray(); // range of s-d separations in mm
        var zs = new DoubleRange(start: 0.1, stop: 20.0, number: 100).AsEnumerable().ToArray(); // range of depths in mm
