...
namespace Vts.Test.Modeling.Spectroscopy
{
    ...
    public class TissueTests
    {
        ...
        public void Test_get_mua()
        {
            ...
            Assert.AreEqual(0.067809, mua, 0.000001);
        }
        ...
        public void Test_get_optical_properties()
        {
            ...
            Assert.AreEqual(0.067809, opticalProperties.Mua, 0.000001);
        ...
        public void Test_get_optical_properties_wavelength_array()
        {
            ...
            Assert.AreEqual(0.314685, opticalPropertyArray[0].Mua, 0.000001);
            ...
            Assert.AreEqual(0.036131, opticalPropertyArray[1].Mua, 0.000001);
            ...
            Assert.AreEqual(0.067809, opticalPropertyArray[2].Mua, 0.000001);
