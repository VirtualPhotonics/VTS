...
[TestFixture]
public class TransmittedDynamicMTOfFxAndSubregionHistDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testtransmitteddynamicmtoffxandsubregionhist");
    }
