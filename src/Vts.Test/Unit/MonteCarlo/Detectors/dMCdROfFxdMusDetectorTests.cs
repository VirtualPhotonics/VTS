...
[TestFixture]
public class dMCdROfFxdMusDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testdmcdroffxdmus");
    }
    ...
    {
        const string detectorName = "testdmcdroffxdmus";
        var detector = new dMCdROfFxdMusDetector
        {
