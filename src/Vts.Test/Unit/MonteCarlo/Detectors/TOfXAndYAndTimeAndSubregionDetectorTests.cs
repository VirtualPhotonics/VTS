...
[TestFixture]
public class TOfXAndYAndTimeAndSubregionDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testtofxandyandtimeandsubregion");
    }
    ...
    public void Validate_deserialized_binary_arrays_are_correct_when_using_GetBinarySerializers(bool tallySecondMoment)
    {
        ...
        Assert.That(detector.TOfXAndY[0, 0], Is.EqualTo(49));
        Assert.That(detector.TOfXAndY[0, 1], Is.EqualTo(50));
        Assert.That(detector.TOfXAndY[1, 0], Is.EqualTo(51));
        Assert.That(detector.TOfXAndY[1, 1], Is.EqualTo(52));
        ...
        Assert.That(detector.TOfXAndYSecondMoment[0, 0], Is.EqualTo(53));
        Assert.That(detector.TOfXAndYSecondMoment[0, 1], Is.EqualTo(54));
        Assert.That(detector.TOfXAndYSecondMoment[1, 0], Is.EqualTo(55));
        Assert.That(detector.TOfXAndYSecondMoment[1, 1], Is.EqualTo(56));
    }
}