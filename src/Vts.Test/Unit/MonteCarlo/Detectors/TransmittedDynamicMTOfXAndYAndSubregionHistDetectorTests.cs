...
[TestFixture]
public class TransmittedDynamicMTOfXAndYAndSubregionHistDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testtransmitteddynamicmtofxandyandsubregionhist");
    }
