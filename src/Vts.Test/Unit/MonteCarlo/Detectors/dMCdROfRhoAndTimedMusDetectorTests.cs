...
[TestFixture]
public class dMCdROfRhoAndTimedMusDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testdmcdrofrhoandtimedmus");
    }
    ...
    {
        const string detectorName = "testdmcdrofrhoandtimedmus";
        var detector = new dMCdROfRhoAndTimedMusDetector
        {
