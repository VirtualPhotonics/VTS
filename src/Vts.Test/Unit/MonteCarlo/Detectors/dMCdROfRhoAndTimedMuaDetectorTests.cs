...
[TestFixture]
public class dMCdROfRhoAndTimedMuaDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testdmcdrofrhoandtimedmua");
    }
    ...
    {
        const string detectorName = "testdmcdrofrhoandtimedmua";
        var detector = new dMCdROfRhoAndTimedMuaDetector
        {
