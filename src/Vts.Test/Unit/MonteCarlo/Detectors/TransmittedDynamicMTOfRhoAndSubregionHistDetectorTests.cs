...
[TestFixture]
public class TransmittedDynamicMTOfRhoAndSubregionHistDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testtransmitteddynamicmtofrhoandsubregionhist");
    }
