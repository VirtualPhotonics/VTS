...
[TestFixture]
public class pMCROfRhoAndTimeAndSubregionRecessedDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testpmcrofrhoandtimeandsubregionrecessed");
    }
    ...
    {
        const string detectorName = "testpmcrofrhoandtimeandsubregionrecessed";
        var detector = new pMCROfRhoAndTimeAndSubregionRecessedDetector
        {
