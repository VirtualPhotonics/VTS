...
public class InternalSurfaceFiberDetectorTests
{
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testinternalsurfacefiber");
    }
    ...
    {
        const string detectorName = "testinternalsurfacefiber";
        var detector = new InternalSurfaceFiberDetector
        {
