...
[TestFixture]
public class dMCdROfFxdMuaDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testdmcdroffxdmua");
    }
    ...
    {
        const string detectorName = "testdmcdroffxdmua";
        var detector = new dMCdROfFxdMuaDetector
        {
