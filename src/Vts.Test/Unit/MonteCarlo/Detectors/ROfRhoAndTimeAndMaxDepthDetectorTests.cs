...
[TestFixture]
public class ROfRhoAndTimeAndMaxDepthDetectorTests
{
    /// <summary>
    ...
    public void Clear_previously_generated_files()
    {
        ...
        FolderCleanup.DeleteFileContaining(currentPath, "testrofrhoandtimeandmaxdepth");
    }
    ...
    {
        const string detectorName = "testrofrhoandtimeandmaxdepth";
        var detector = new ROfRhoAndTimeAndMaxDepthDetector
        {
            Rho = new DoubleRange(0, 10, 3),
            Time = new DoubleRange(-10, 10, 3),
