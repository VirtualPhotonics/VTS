...
{
    /// <summary>
    /// Unit tests for MultiInfiniteCylinderTissue: this has base class MultiInclusionTissue so
    /// methods in MultiInclusionTissue are tested in the MultiInclusionTissue unit tests.
    /// </summary>
    [TestFixture]
    public class MultiInfiniteCylinderTissueTests
    {
        /// <summary>
