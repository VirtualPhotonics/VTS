...
namespace Vts.Test.MonteCarlo.Detectors
{
    ...
    public class DAWLayersDynamicFxDetectorsTests
    {
        ...
        public void execute_Monte_Carlo()
        {
            ...
            var oneLayerTissue = new MultiLayerTissueInput(
                new ITissueRegion[]
                {
            ...
            oneLayerTissue.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey1", new HenyeyGreensteinPhaseFunctionInput());
            oneLayerTissue.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey2", new HenyeyGreensteinPhaseFunctionInput());
            oneLayerTissue.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey3", new HenyeyGreensteinPhaseFunctionInput());
            ...
            var twoLayerTissue = new MultiLayerTissueInput(
                new ITissueRegion[]
                {
                    new LayerTissueRegion(
                        new DoubleRange(double.NegativeInfinity, 0.0),
            ...
            twoLayerTissue.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey1", new HenyeyGreensteinPhaseFunctionInput());
            twoLayerTissue.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey2", new HenyeyGreensteinPhaseFunctionInput());
            twoLayerTissue.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey3", new HenyeyGreensteinPhaseFunctionInput());
            twoLayerTissue.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey4", new HenyeyGreensteinPhaseFunctionInput());
        ...
        public void validate_DAW_ReflectedDynamicMTOfFxAndSubregionHist()
        {
            ...
            for (int i = 0; i < fxs.Count; i++)
            {
                for (int j = 0; j < mtbins.Count - 1; j++)
                {
                    ...
                    {
                        integral += _outputOneLayerTissue.RefDynMT_fxmt_frac[i, j, m].Real + 
