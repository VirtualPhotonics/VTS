...
namespace Vts.Test.MonteCarlo.Detectors
{
    ...
    public class InclusionWithRefractiveIndexMismatchTests
    {
        ...
        public void Execute_Monte_Carlo()
        {
            ...
            var tissueTwoRegion = new SingleInfiniteCylinderTissueInput(
            ...
            tissueTwoRegion.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey1", new HenyeyGreensteinPhaseFunctionInput());
            tissueTwoRegion.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey2", new HenyeyGreensteinPhaseFunctionInput());
            tissueTwoRegion.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey3", new HenyeyGreensteinPhaseFunctionInput());
            tissueTwoRegion.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey4", new HenyeyGreensteinPhaseFunctionInput());
            ...
            var tissueTwoRegionWithMismatch = new SingleInfiniteCylinderTissueInput(
                new InfiniteCylinderTissueRegion(
                    new Position(0, 0, 2), // center
                    1, // radius
            ...
            tissueTwoRegionWithMismatch.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey1", new HenyeyGreensteinPhaseFunctionInput());
            tissueTwoRegionWithMismatch.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey2", new HenyeyGreensteinPhaseFunctionInput());
            tissueTwoRegionWithMismatch.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey3", new HenyeyGreensteinPhaseFunctionInput());
            tissueTwoRegionWithMismatch.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey4", new HenyeyGreensteinPhaseFunctionInput());
        ...
        public void Validate_DAW_voxel_RDiffuse()
        {
            ...
            Assert.That(Math.Abs(_outputTwoRegionMismatchedTissue.Rd - 0.646391), Is.LessThan(0.000001));
        }
        ...
        public void Validate_DAW_voxel_ROfAngle()
        {
            ...
            Assert.That(Math.Abs(_outputTwoRegionMismatchedTissue.R_a[0] - 0.092621), Is.LessThan(0.000001));
        }
        ...
        public void Validate_DAW_voxel_TDiffuse()
        {
            ...
            Assert.That(Math.Abs(_outputTwoRegionMismatchedTissue.Td - 0.020237), Is.LessThan(0.000001));
        }
        ...
        public void Validate_DAW_voxel_TOfAngle()
        {
            ...
            Assert.That(Math.Abs(_outputTwoRegionMismatchedTissue.T_a[0] - 0.002899), Is.LessThan(0.000001));
        }
        ...
        public void Validate_DAW_voxel_ROfXAndY()
        {
            ...
            Assert.That(Math.Abs(_outputTwoRegionMismatchedTissue.R_xy[198, 201] - 0.009802), Is.LessThan(0.000001));
        }
        ...
        public void Validate_DAW_voxel_ATotal()
        {
            ...
            Assert.That(Math.Abs(_outputTwoRegionMismatchedTissue.Atot - 0.333370), Is.LessThan(0.000001));
        }
        ...
        public void Validate_DAW_voxel_RDiffuse_plus_ATotal_plus_TDiffuse_equals_one()
        {
            ...
            Assert.That(Math.Abs(_outputOneRegionTissue.Rd + 
                                 _outputOneRegionTissue.Atot + 
                                 _outputOneRegionTissue.Td - 1), Is.LessThan(0.00000000001));
            Assert.That(Math.Abs(_outputTwoRegionMatchedTissue.Rd + 
                                 _outputTwoRegionMatchedTissue.Atot + 
                                 _outputTwoRegionMatchedTissue.Td - 1), Is.LessThan(0.00000000001));
            Assert.That(Math.Abs(_outputTwoRegionMismatchedTissue.Rd + 
                                 _outputTwoRegionMismatchedTissue.Atot + 
                                 _outputTwoRegionMismatchedTissue.Td - 1), Is.LessThan(0.00000000001));
        }
    }
}
