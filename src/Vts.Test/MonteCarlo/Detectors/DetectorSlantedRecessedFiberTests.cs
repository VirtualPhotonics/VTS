...
namespace Vts.Test.MonteCarlo.Detectors
{
    ...
    public class DetectorSlantedRecessedFiberTests
    {
        ...
        public void Execute_Monte_Carlo()
        {
            ...
            _tissueForSlantedRecessedFiber.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey1", new HenyeyGreensteinPhaseFunctionInput());
            _tissueForSlantedRecessedFiber.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey2", new HenyeyGreensteinPhaseFunctionInput());
            _tissueForSlantedRecessedFiber.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey3", new HenyeyGreensteinPhaseFunctionInput());
            ...
            _tissueForSurfaceFiber.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey1", new HenyeyGreensteinPhaseFunctionInput());
            _tissueForSurfaceFiber.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey2", new HenyeyGreensteinPhaseFunctionInput());
            _tissueForSurfaceFiber.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey3", new HenyeyGreensteinPhaseFunctionInput());
            _tissueForSurfaceFiber.RegionPhaseFunctionInputs.Add("HenyeyGreensteinKey4", new HenyeyGreensteinPhaseFunctionInput());
