...
namespace Vts.Test.MonteCarlo.Detectors
{
    ...
    public class DetectorNATests
    {
        ...
        private const double LayerThickness = 10.0; // make thin so transmittance occurs
        // specify DosimetryDepth to be bottom of homogeneous tissue.  This is not what would typically
        // be done but for sake of testing purposes it can satisfy that DosimetryDepth is at layer interface
        private const double DosimetryDepth = LayerThickness; 
        ...
        public void Execute_Monte_Carlo()
        {
            ...
            var tissue = new MultiLayerTissueInput(
                new ITissueRegion[]
                {
                    ...
                    new LayerTissueRegion( 
                        new DoubleRange(0.0, LayerThickness), // make tissue layer thin so transmittance results improved
