...
{
    [TestFixture]
    public class dMCdROfRhoAndTimedMusDetectorInputValidationTests
    {
        /// <summary>
        ...
        public void validate_only_one_perturbed_region_index_specified()
        {
            ...
            ((dMCdROfRhoAndTimedMusDetectorInput) detectorInput.First()).PerturbedRegionsIndices = new List<int> {1};
