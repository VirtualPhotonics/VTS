...
{
    [TestFixture]
    public class dMCdROfRhoAndTimedMuaDetectorInputValidationTests
    {
        /// <summary>
        ...
        public void validate_only_one_perturbed_region_index_specified()
        {
            ...
            var detectorInput = new List<IDetectorInput>
            {
                new dMCdROfRhoAndTimedMuaDetectorInput
                {
                    ...
                    // set number of perturbed regions 
            ...
            ((dMCdROfRhoAndTimedMuaDetectorInput) detectorInput.First()).PerturbedRegionsIndices = new List<int> {1};
