...
{
    [TestFixture]
    public class dMCdROfFxdMusDetectorInputValidationTests
    {
        /// <summary>
        ...
        public void validate_only_one_perturbed_region_index_specified()
        {
            ...
            ((dMCdROfFxdMusDetectorInput) detectorInput.First()).PerturbedRegionsIndices = new List<int> {1};
