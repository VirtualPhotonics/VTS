...
namespace Meta.Numerics.Statistics
{
    ...
    public class MannWhitneyDistribution : Distribution
    {
        ...
        public override double LeftProbability(double x)
        {
            return (
#if SILVERLIGHT
                    LeftInclusiveProbability((int) Decimal.Truncate((decimal)x)) 
#else
                    LeftInclusiveProbability((int)Math.Truncate(x))
#endif
                    );
        }
        ...
        public override double RightProbability(double u)
        {
            return (
#if SILVERLIGHT
                RightExclusiveProbability((int)Decimal.Truncate((decimal)u))
#else
                RightExclusiveProbability((int)Math.Truncate(u))
#endif
                );
        }
