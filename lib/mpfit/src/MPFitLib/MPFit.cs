...
namespace MPFitLib
{
    public static class MPFit
    {
        ...
        * ********** */
        ...
        private static void mp_qrfac(int m, int n, double[] a, int lda,
        ...
        private static void mp_qrsolv(int n, double[] r, int ldr, int[] ipvt, double[] diag,
        ...
        private static void mp_lmpar(int n, double[] r, int ldr, int[] ipvt, int[] ifree, double[] diag,
        ...
        */
        ...
        private static int mp_covar(int n, double[] r, int ldr, int[] ipvt, double tol, double[] wa)
        {
            int i, ii, j, jj, k, l;
