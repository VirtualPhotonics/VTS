...
[status]=system(sprintf('replace_string var1 %s %s','rho',infile_PP));
[status]=system(sprintf('replace_string a1 %f %s',mua,infile_PP));
[status]=system(sprintf('replace_string s1 %f %s',mus,infile_PP));
[status]=system(sprintf('replace_string sp1 %f %s',musp,infile_PP));
